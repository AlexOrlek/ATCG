...
vis_group2.add_argument('--dna_seg_label_cex', help='The relative size of dna_seg_labels text (default: 1)', default='1',type=positivefloat)
...
vis_group2.add_argument('--scale', help='Should a global scale be shown at the bottom of the plot; provide true/false (case-insensitive) (default: true)', default='true',choices=['true','True','TRUE','false','False','FALSE'],type=str)
vis_group2.add_argument('--dna_seg_scale', help='Should per-genome scales be shown; provide true/false (case-insensitive) (default: true)', default='false',choices=['true','True','TRUE','false','False','FALSE'],type=str)
vis_group2.add_argument('--dna_seg_scale_cex', help='The relative size of per-genome scales (default: 1)', default='1',type=positivefloat)

#annotation-related
vis_group3 = parser.add_argument_group('Visualisation options: annotation-related')
vis_group3.add_argument('--annotation_gene_type', help='Specifies the default symbol to represent annotations (default: side_bars)', default='side_bars', choices=['arrows','headless_arrows','blocks','bars','points','text','lines','side_blocks','side_bars','side_points','side_text','side_lines','introns','exons','side_exons'],type=str)
...
vis_group3.add_argument('--annotation_lwd', help='Specifies the default outline line width of the annotation symbol (default: 1)', default='1',type=positiveint)
