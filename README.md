...
`--gffannotationtype` specifies which annotation types to include. Annotation type is given in the 3rd column of a gff3 file; by default only coding sequences (CDS) are plotted.
